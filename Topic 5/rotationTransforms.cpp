...
int main ( int argc, char** argv )
{
    ...
    cout<<"旋转矩阵转化为旋转向量：rotation_vector axis = " <<rotation_vector.fromRotationMatrix(rotation_matrix).axis().transpose()
    ...
    euler_angles = rotation_matrix.eulerAngles(M_PI/4,0,0);
